...
public:
  // Anweisung zur Hausaufgabe
    /* 
   * o Kopieren Sie hier ihre Klasse TSpieler aus der Präsenz Übung                       
   * o Erweitern Sie die Funktion "Laufe" um eine Übergabe der Referenz TBall &ball       
   * o Deklarieren Sie die Funktion "Laufe" als virtual                                   
   */
